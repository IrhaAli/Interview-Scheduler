...
describe("Form", () => {
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    /* 2. Render the Form with interviewers and the onSave mock function passed as an onSave prop, the interviewer prop should be blank or undefined */
    const { getByText } = render(
  ...
  it("calls onSave function when the name and interviewer is defined", () => {
    ...
    expect(onSave).toHaveBeenCalledWith({ student: "Lydia Miller-Jones", interviewer: 1 });
  });
